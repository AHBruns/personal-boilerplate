...
var objectToTreeItem = function objectToTreeItem(object) {
  ...
  return entries.map(function (_ref) {
    ...
    if (typeof value !== "object") return __jsx(_material_ui_lab__WEBPACK_IMPORTED_MODULE_4__["TreeItem"], {
      nodeId: uuid_v4__WEBPACK_IMPORTED_MODULE_6___default()(),
      label: "".concat(key.toString(), " = ").concat(value.toString),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 15
      },
      __self: this
    });else return __jsx(_material_ui_lab__WEBPACK_IMPORTED_MODULE_4__["TreeItem"], {
      nodeId: uuid_v4__WEBPACK_IMPORTED_MODULE_6___default()(),
      label: key.toString(),
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=palette.js.9e9ca6fc98afffa6c18a.hot-update.js.map