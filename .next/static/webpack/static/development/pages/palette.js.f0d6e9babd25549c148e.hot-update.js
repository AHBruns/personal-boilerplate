...
var toTreeItems = function toTreeItems(object) {
  ...
  return entries.map(function (_ref) {
    ...
    // return <TreeItem nodeId={uuid()} label={key} />;
    switch (typeof value) {
      case "number":
        return __jsx(_material_ui_lab__WEBPACK_IMPORTED_MODULE_3__["TreeItem"], {
          nodeId: uuid_v4__WEBPACK_IMPORTED_MODULE_5___default()(),
          label: key,
          __source: {
...
//# sourceMappingURL=palette.js.f0d6e9babd25549c148e.hot-update.js.map